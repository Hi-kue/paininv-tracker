...
const FeatureCard = ({ feature, icon: Icon, description }) => (
  <motion.div 
    className="aspect-video rounded-xl w-80 shadow-lg ring-1 ring-black/5 bg-white/5 backdrop-blur-xl p-6 hover:shadow-xl transition-all duration-300 ease-in border border-white/10 hover:-mt-2 hover:mb-2"
  ...
  >
    ...
    <h3 className="text-xl font-bold mb-2 text-black dark:text-slate-300">{feature}</h3>
    ...
    <div className="relative min-h-screen overflow-hidden text-white">      
      ...
      <div className="relative z-10 mt-5 lg:mt-0">
        <section className="container min-h-screen flex flex-col justify-center items-center gap-8 pb-8 pt-6 md:py-10">
          ...
          >
            <Image src="/imgs/paninv-tracker-logo.png" width={100} height={100} alt="Paninv Tracker Logo" />
            <motion.h1 
            ...
            >
              The best dashboard to keep track of your inventory, manage your recipes, and more.
            </motion.p>
          </motion.div>
          ...
          >
            <MotionLink
              href="/dashboard"
              className={buttonVariants({ variant: "default", size: "lg"}) + " bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-semibold px-8 py-4 rounded-full"}
          ...
          >
            ...
            <FeatureCard 
              ...
              description={
                <>
                  <span>The code is completely free and available on Github, simply click on the link to check it out the following link: </span>
                  <Link href={appConfig.links.github} className="text-indigo-400 hover:underline">
